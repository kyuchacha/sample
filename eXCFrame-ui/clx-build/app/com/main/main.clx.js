...
(function(){
	var app = new cpr.core.App("app/com/main/main", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_2.action = "/Login/logout.do";
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						formLayout_3.setColumns(["16px", "16px"]);
			...
			(function(container){
				...
				image_2.src = "theme/common/images/com/main/main-logo.png";
				image_2.alt = "로고";
				image_2.style.css({
					"padding-top" : "6px",
					"padding-left" : "6px",
			...
			formLayout_4.setColumns(["35px", "35px", "1fr", "75px", "35px", "35px", "35px", "35px", "35px", "50px"]);
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						var button_3 = new cpr.controls.Button("btnMToggle");
						button_3.fieldLabel = "검색";
						button_3.value = "";
						button_3.style.setClasses(["btn-nav-toggle"]);
						if(typeof onBtnMToggleClick == "function") {
							button_3.addEventListener("click", onBtnMToggleClick);
						}
				...
				(function(container){
					...
					button_4.tooltip = "메뉴검색";
					button_4.value = "";
					button_4.style.setClasses(["btn-nav-search"]);
				...
				navigationBar_1.style.setClasses(["mega-menu"]);
				navigationBar_1.style.list.setClasses(["mega-menu-left"]);
				(function(navigationBar_1){
					navigationBar_1.setItemSet(app.lookup("dsAllMenu"), {
						"label": "MENU_NM",
						"value": "MENU_ID",
						"tooltip": "MENU_NM",
						"parentValue": "UP_MENU_ID"
				...
				(function(container){
					var button_5 = new cpr.controls.Button("btnAlrt");
					button_5.fieldLabel = "알림(메세지)";
					button_5.value = "";
					button_5.userAttr({"prevent-click": "true"});
					button_5.style.bindClass().toExpression("#dsMsgStack.getRowCount() > 0 ? \"btn-nav-alert on\" : \"btn-nav-alert\"");
					if(typeof onBtnAlrtClick == "function") {
						button_5.addEventListener("click", onBtnAlrtClick);
					}
				...
				(function(container){
					var button_6 = new cpr.controls.Button("btnSetting");
					button_6.fieldLabel = "설정";
					button_6.value = "";
					button_6.userAttr({"prevent-click": "true"});
					button_6.style.setClasses(["btn-nav-setting"]);
					if(typeof onBtnSettingClick == "function") {
						button_6.addEventListener("click", onBtnSettingClick);
					}
				...
				var button_7 = new cpr.controls.Button("btnCstmzMenu");
				button_7.fieldLabel = "사용자 메뉴(즐겨찾기)";
				button_7.visible = false;
				button_7.value = "";
				button_7.userAttr({"prevent-click": "true"});
				button_7.style.setClasses(["btn-nav-usermenu"]);
				if(typeof onBtnCstmzMenuClick == "function") {
					button_7.addEventListener("click", onBtnCstmzMenuClick);
				}
				...
				if(typeof onOptTimeValueChange2 == "function") {
					output_4.addEventListener("value-change", onOptTimeValueChange2);
				}
				...
				(function(comboBox_3){
					comboBox_3.addItem(new cpr.controls.Item("PC", "pc"));
					comboBox_3.addItem(new cpr.controls.Item("MOB", "mobile"));
				})(comboBox_3);
			...
			var group_16 = new cpr.controls.Container("grpCnHdR");
			group_16.style.setClasses(["btn-nav-group"]);
			// Layout
			...
			(function(container){
				var button_8 = new cpr.controls.Button("btnDropdown");
				button_8.fieldLabel = "컨텐츠 버튼 그룹 보기";
				button_8.visible = false;
				button_8.value = "";
				button_8.style.setClasses(["btn-nav-dropdown", "rounded-circle"]);
				if(typeof onBtnDropdownClick == "function") {
					button_8.addEventListener("click", onBtnDropdownClick);
				}
				...
				var button_9 = new cpr.controls.Button("btnScale");
				button_9.fieldLabel = "화면 배율 원복";
				button_9.tooltip = "화면 배율 원복";
				button_9.value = "";
				button_9.style.setClasses(["rounded-circle"]);
				button_9.style.css({
					"background-image" : "url('theme/common/images/controls/dialog/icon-restore.png')"
				});
				if(typeof onBtnScaleClick == "function") {
					button_9.addEventListener("click", onBtnScaleClick);
				}
				...
				var button_10 = new cpr.controls.Button("btnCareReq");
				button_10.fieldLabel = "변경요청";
				button_10.tooltip = "변경요청";
				button_10.visible = false;
				button_10.style.setClasses(["btn-care-req", "rounded-circle"]);
				...
				var button_11 = new cpr.controls.Button("btnZoom");
				button_11.fieldLabel = "컨텐츠 확대/축소";
				button_11.tooltip = "확대/축소";
				button_11.value = "";
				button_11.style.setClasses(["btn-nav-zoom", "rounded-circle"]);
				button_11.bind("visible").toExpression("#btnDropdown.visible ? false : true");
				if(typeof onBtnZoomClick == "function") {
					button_11.addEventListener("click", onBtnZoomClick);
				}
				container.addChild(button_11, {
					"width": "30px",
					"height": "30px"
				});
				var button_12 = new cpr.controls.Button("btnRefresh");
				button_12.fieldLabel = "컨텐츠 새로고침";
				button_12.tooltip = "새로고침";
				button_12.value = "";
				button_12.style.setClasses(["btn-nav-refresh", "rounded-circle"]);
				button_12.bind("visible").toExpression("#btnDropdown.visible ? false : true");
				if(typeof onBtnRefreshClick == "function") {
					button_12.addEventListener("click", onBtnRefreshClick);
				}
				...
				button_13.fieldLabel = "컨텐츠 모두닫기";
				button_13.tooltip = "모두닫기";
				button_13.value = "";
				button_13.style.setClasses(["btn-nav-close", "rounded-circle"]);
			...
			mDIFolder_1.addHeaderControl(group_16, {"position": "right", "width": 370});
			var group_17 = new cpr.controls.Container("grpCnHdH");
			// Layout
			var xYLayout_9 = new cpr.controls.layouts.XYLayout();
			xYLayout_9.scrollable = false;
			group_17.setLayout(xYLayout_9);
			(function(container){
				var button_14 = new cpr.controls.Button("btnDfItem");
				button_14.value = "";
				button_14.style.setClasses(["default-tabfolder-item", "cl-selected"]);
				if(typeof onBtnDfItemClick == "function") {
					button_14.addEventListener("click", onBtnDfItemClick);
				}
			...
			mDIFolder_1.addHeaderControl(group_17, {"position": "heading", "width": 40});
			...
			if(typeof onMdiCnContentInit == "function") {
				mDIFolder_1.addEventListener("content-init", onMdiCnContentInit);
			}
			...
			(function(container){
				...
				(function(container){
					...
					var button_15 = new cpr.controls.Button("btnRbClose");
					button_15.value = "";
					button_15.style.setClasses(["btn-panel-close", "rounded-circle"]);
					if(typeof onBtnRbCloseClick == "function") {
						button_15.addEventListener("click", onBtnRbCloseClick);
					}
			...
			var group_21 = new cpr.controls.Container("grpCnHdRVrt");
			group_21.visible = false;
			group_21.clipContent = false;
			group_21.style.setClasses(["btn-nav-group"]);
			// Layout
			...
			(function(container){
				var button_16 = new cpr.controls.Button("btnVrtZoom");
				button_16.value = "";
				button_16.style.setClasses(["btn-nav-zoom", "rounded-circle", "box-shadow"]);
				if(typeof onBtnVrtZoomClick == "function") {
					button_16.addEventListener("click", onBtnVrtZoomClick);
				}
				container.addChild(button_16, {
					"width": "30px",
					"height": "30px"
				});
				var button_17 = new cpr.controls.Button("btnVrtRefresh");
				button_17.value = "";
				button_17.style.setClasses(["btn-nav-refresh", "rounded-circle", "box-shadow"]);
				if(typeof onBtnVrtRefreshClick == "function") {
					button_17.addEventListener("click", onBtnVrtRefreshClick);
				}
				container.addChild(button_17, {
					"width": "30px",
					"height": "30px"
				});
				var button_18 = new cpr.controls.Button("btnVrtClose");
				button_18.value = "";
				button_18.style.setClasses(["btn-nav-close", "rounded-circle", "box-shadow"]);
				if(typeof onBtnVrtCloseClick == "function") {
					button_18.addEventListener("click", onBtnVrtCloseClick);
				}
			...
			if(typeof onGrpCnHdRVrtClick == "function") {
				group_21.addEventListener("click", onGrpCnHdRVrtClick);
			}
			...
			var group_22 = new cpr.controls.Container("grpNotiBox");
			group_22.visible = false;
			group_22.style.setClasses(["dropdown-menu"]);
			// Layout
			...
			(function(container){
				...
				formLayout_7.setColumns(["1fr", "55px"]);
				...
				var group_24 = new cpr.controls.Container("grpNotiItemWrap");
				// Layout
			...
			var comboBox_5 = new cpr.controls.ComboBox("cmbUnfd");
			comboBox_5.visible = false;
			comboBox_5.filterExp = "CALL_PAGE != \"\"";
			comboBox_5.hideButton = true;
			comboBox_5.showIcon = true;
			comboBox_5.style.setClasses(["search-combo"]);
			(function(comboBox_5){
				comboBox_5.setItemSet(app.lookup("dsAllMenu"), {
					"label": "MENU_NM",
					"value": "MENU_ID"
				});
			})(comboBox_5);
			if(typeof onCmbUnfdSelectionChange == "function") {
				comboBox_5.addEventListener("selection-change", onCmbUnfdSelectionChange);
			}
