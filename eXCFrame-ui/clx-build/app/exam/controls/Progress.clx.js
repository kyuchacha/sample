				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "프로그레스의 값을 설정하는 속상입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "프로그레스 내부에 value가 표시되는 설정을 할 수 있는 속성입니다.";
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 프로그레스 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_31.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_39.value = "get 호출시 반환되는 내용을 입력하세요.";
							output_39.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_40.value = "set으로 설정 가능한 내용을 입력하세요.";
							output_40.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_44.value = "하단의 컨트롤에서 입력값이 적용된 속성의 기능을 확인 할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_48.value = "프로그래스내 텍스트를 보여줄 형식을 표현식을 통해 정의하는 속성입니다. showText가 true일때 적용됩니다.";
						...
						(function(container){
							...
							output_58.value = "하단의 컨트롤에서 입력값이 적용된 속성의 기능을 확인 할 수 있습니다.";
