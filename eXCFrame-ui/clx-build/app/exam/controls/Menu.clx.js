				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "메뉴 내 아이템을 화면에 보여줄 형식을 표현식의 형태로 정의하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_22.value = "메뉴내 아이템 활성화 여부를 표현식을 통해 정의하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_36.value = "표현식을 통해 아이템을 필터링 하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_50.value = "서브 메뉴를 펼치는 방향을 설정하는 속성입니다. 기본값은 lr 이고 rtl로 변경시 방향이 바뀌게 됩니다.\r\n[ltr] : left to right. 오른쪽으로 펼쳐집니다.\r\n[rtl] : right to left. 왼쪽으로 펼쳐집니다.";
						...
						(function(container){
							...
							output_60.value = "1) 우측의 입력값을 선택하고 확인 버튼을 클릭합니다.\r\n2) 하단의 컨트롤에서 서브메뉴가 펼쳐지는 방향이 바뀌는 것을 확인할 수 있습니다.";
					...
					(function(container){
						...
						output_62.value = "expanderTrigger";
						output_62.style.css({
							"color" : "#2263b3",
							"font-weight" : "700",
							"font-size" : "20px",
						...
						(function(container){
							...
							output_63.value = "서브메뉴를 확장하는 방법을 설정하는 속성입니다. 기본값은 hover이며 click으로 변경 시 클릭하기 이전에는 메뉴가 확장되지 않습니다.";
