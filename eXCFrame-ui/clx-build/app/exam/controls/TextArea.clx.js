/*
 * App URI: app/exam/controls/TextArea
 * Source Location: app/exam/controls/TextArea.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/controls/TextArea", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			/************************************************
			 * TextArea.js
			 * Created at 2022. 3. 11. 오후 3:25:58.
			 *
			 * @author 1amthomas
			 ************************************************/
			...
			function onBtnInitClick(e){
				...
				app.lookup("sampleTxa1").placeholder = select;
			}
			...
			function onBtnInit2Click(e){
				...
				app.lookup("sampleTxa2").maxLength = Number(select);
				app.lookup("sampleTxa2").focus();
			}
			...
			function onBtnInit4Click(e){
				...
				if(select == "true"){
					app.lookup("sampleTxa4").autoSelect = true;		
				}else{
					app.lookup("sampleTxa4").autoSelect = false;	
				}
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "여러 줄의 텍스트를 입력할 수 있는 컨트롤입니다.\r\n\r\n입력된 텍스트가 너비를 넘어갈 경우 자동으로 줄바꿈이 됩니다.\r\n사용자가 자유롭게 텍스트에 입력 / 출력이 가능합니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_3.value = "<기본 텍스트 에리어 컨트롤>";
							output_3.style.setClasses(["text-center"]);
							container.addChild(output_3, {
								"colIndex": 0,
								"rowIndex": 1
							});
							var textArea_1 = new cpr.controls.TextArea("defaultTxa");
						...
						(function(container){
							...
							userDefinedControl_2.value = "var textArea_1 = new cpr.controls.TextArea(\"txa1\");\r\n\r\n/* tab 키 눌렀을 때 순서 */\r\ntextArea_1.tabIndex = 1;\r\n\r\n/* 텍스트 에리어 입력 가능한 최대 문자 수 */\r\ntextArea_1.maxLength = 5;\r\n\r\n/* 입력된 문자열 길이가 maxLength 도달했을 경우 다음 컨트롤로 포커스 이동 */\r\n/* maxLength 속성이 존재할 시 해당 속성 동작 */\r\ntextArea_1.autoskip = true;";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "컨트롤에 값이 들어있지 않을때 출력되는 문구를 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_13.value = "설명 또는 예상된 값에 대한 문구(힌트)를 반환합니다.";
							output_13.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_14.value = "설명 또는 예상된 값에 대한 문구(힌트)를 설정합니다.";
							output_14.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var textArea_2 = new cpr.controls.TextArea("sampleTxa1");
								textArea_2.maxLength = 0;
								textArea_2.autoSkip = true;
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "컨트롤에 최대 입력할 수 있는 길이를 설정하는 속성입니다. lengthUnit에 따라 값이 달라 질 수 있습니다.";
						...
						(function(container){
							...
							output_26.value = "입력이 가능한 최대 문자 수를 반환합니다.";
							output_26.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_27.value = "입력이 가능한 최대 문자 수를 설정합니다. \r\n관련 속성 : [lengthUnit] lengthUnit 속성에 따라 설정됩니다.";
							output_27.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_31.value = "1) 입력값을 선택하고 실행 버튼을 클릭합니다.\r\n2) 하단의 텍스트 에리어에 선택값 이상의 텍스트가 입력되지 않는것을 확인 할 수 있습니다. ";
						...
						(function(container){
							...
							(function(container){
								...
								var textArea_3 = new cpr.controls.TextArea("sampleTxa2");
								textArea_3.maxLength = 0;
								textArea_3.autoSkip = false;
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "입력한 문자열의 길이가 maxlength에 도달 했을 경우 다음 컨트롤로 포커스 이동 여부를 설정하는 속성입니다. 기본값은 false이며 true로 변경시 포커스가 가능해집니다.";
						...
						(function(container){
							...
							output_39.value = "입력된 문자열의 길이가 maxLength 도달했을 경우 다음 컨트롤로 포커스 이동 여부를 반환 합니다.";
							output_39.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_40.value = "입력된 문자열의 길이가 maxLength 도달했을 경우 다음 컨트롤로 포커스 이동 여부를 설정합니다.";
							output_40.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_45.value = "1) 우측의 입력값 속성에 따른 탭 폴더의 기능을 하단에서 확인할 수 있습니다.\r\n2) 텍스트 에리어에 5자이상 텍스트를 입력합니다.\r\n3) 포커싱이 다음으로 넘어가는것을 확인합니다.";
						...
						(function(container){
							...
							(function(container){
								...
								var textArea_4 = new cpr.controls.TextArea("sampleTxa3");
								textArea_4.value = "가나다라";
								textArea_4.maxLength = 5;
								textArea_4.autoSkip = true;
					...
					(function(container){
						...
						(function(container){
							...
							output_48.value = "텍스트 에리어 컨트롤에 포커스가 될 때 편집 영역의 데이터를 전체 선택할수 있게 설정하는 속성입니다. 기본값은 false이며 true로 변경 시 포커스가 생겼을때 전체 값이 선택됩니다.";
						...
						(function(container){
							...
							output_53.value = "포커스 될 시 편집 영역의 데이터 전체 선택 여부를 반환합니다.";
							output_53.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_54.value = "포커스 될 시 편집 영역의 데이터 전체 선택 여부를 설정합니다.";
							output_54.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_58.value = "1) 입력값을 선택하고 실행 버튼을 클릭합니다.\r\n2) 하단의 텍스트 에리어를 클릭하여 속성에 따른 기능 변화를 확인할 수 있습니다.";
						...
						(function(container){
							...
							(function(container){
								...
								var textArea_5 = new cpr.controls.TextArea("sampleTxa4");
								textArea_5.value = "가나다라";
								textArea_5.maxLength = 5;
								textArea_5.autoSelect = true;
								textArea_5.autoSkip = false;
