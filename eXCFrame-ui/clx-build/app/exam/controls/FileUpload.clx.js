		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "다수의 파일을 동시에 업로드 할 수 있는 컨트롤입니다.\r\n\r\n파일 이름, 확장자명, 사이즈, 파일 수 를 확인하며 업로드 가능합니다.\r\n버튼을 통해 추가,삭제,저장 동작을 수행할 수 있습니다.";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_10.value = "파일 업로드 컨트롤에 업로드 된 파일이 없을때 표시되는 텍스트를 설정하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_23.value = "파일 업로드 하단에 정렬된 버튼들을 정렬하거나 추가 삭제 할 수 있는 속성입니다.";
						...
						(function(container){
							...
							output_33.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 파일 업로드 컨트롤에서 입력값에 따라 버튼의 정렬이 바뀌는것을 확인 할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_36.value = "1) limitFileSize : 업로드 할 수 있는 파일들의 크기를 제한하는 속성입니다. 숫자로 값을 설정 할 수 있으며 단위는 limitFileSizeUnit 에 따라 달라집니다.\r\n\r\n2) limitFileSizeUnit : 업로드 할 수 있는 파일들의 크기의 단위 설정하는 속성입니다. 기본값은 kb 이며 byte,mb,gb로 변경이 가능합니다.";
						...
						(function(container){
							...
							output_40.value = "1) 하단의 파일업로드 컨트롤에 파일을 업로드 합니다.\r\n2) 업로드된 파일 용량의 합이 3mb이상이 되면 더이상 업로드가 되지 않습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_44.value = "1) limitSizePerFile : 업로드 할 수 있는 개별파일의 크기를 제한하는 속성입니다. 숫자로 값을 설정 할 수 있으며 단위는 limitFileSizePerUnit 에 따라 달라집니다.\r\n\r\n2) limitSizePerFileUnit : 업로드 할 수 있는 개별파일 크기의 단위 설정하는 속성입니다. 기본값은 kb 이며 byte,mb,gb로 변경이 가능합니다.";
						...
						(function(container){
							...
							output_49.value = "1) 하단의 파일업로드 컨트롤에 파일을 업로드 합니다.\r\n2) 업로드된 개별 파일 용량이 2mb 이상일 경우 업로드 되지 않습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_58.value = "업로드 할 수 있는 파일들의 확장자 명 목록을 설정합니다. 확장자 명 목록은 string으로 일렬로 나열해서 한 문장으로 작성합니다.";
						...
						(function(container){
							...
							output_63.value = "1) 하단의 파일업로드 컨트롤에 추가 버튼을 클릭합니다.\r\n2) 파일 업로드 창 우측 하단에 확장자가 .png인것을 확인합니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_66.value = "파일 업로드 컨트롤에 최대 업로드 될 수 있는 파일의 갯수를 설정할 수 있는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_79.value = "파일 업로드 컨트롤에 파일을 드래그 해서 업로드 할 수 있게 설정하는 속성입니다. 기본값은 true 이며 false로 변경 시 드래그로 파일 업로드가 되지 않습니다.";
						...
						(function(container){
							...
							output_89.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 파일업로드 컨트롤에서 해당 속성에 따른 드래그 앤 드롭 여부를 확인 할 수 있습니다.";
							output_89.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
