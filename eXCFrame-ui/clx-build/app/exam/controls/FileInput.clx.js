		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "사용자가 파일을 선택할 수 있게 해주는 컨트롤 입니다.\r\naccept속성을 사용하여 컨트롤이 선택할 수 있는 파일 유형을 정의할 수 있습니다.";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_10.value = "파일 선택 전에 보여지는 텍스트를 설정하는 속성입니다. 파일이 선택되어 있지 않으면 placeholder에서 지정한 문구가 파일 인풋에 출력됩니다.";
							output_10.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_20.value = "1) 우측의 버튼을 클릭합니다.\r\n\r\n2) 파일인풋의 placeholder가 변경된 것을 확인합니다.";
							output_20.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_24.value = "업로드 할 수 있는 데이터들의 최대 크기를 지정하는 속성입니다. limitSizeFileUnit에 따른 단위가 설정됩니다.\r\nlimitSizeFileUnit의 기본값은 kb이며 byte,mb,gb로 변경이 가능합니다.";
							output_24.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_48.value = "1) 하단의 파일 인풋을 클릭합니다.\r\n\r\n2) 파일인풋 창 우측 하단에 확장자가 PNG로 표시되는 것을 확인할 수 있습니다.";
							output_48.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_52.value = "파일인풋의 다이얼로그에서 다중선택여부를 설정할 수 있는 속성입니다. 기본값은 false이고, true로 변경시 파일 다중 선택이 가능해집니다.";
							output_52.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_66.value = "파일의 드롭 가능 여부를 설정하는 속성입니다. 기본값은 true 이고 , false로 변경 시 파일을 드래그해서 넣을 수 없게 됩니다.";
							output_66.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_76.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 파일 인풋 컨트롤에서 해당 속성에 따른 기능을 확인 할 수 있습니다.";
							output_76.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						output_78.value = "showClearButton";
						output_78.style.css({
							"color" : "#2263b3",
							"font-weight" : "700",
							"font-size" : "20px",
						...
						(function(container){
							...
							output_79.value = "ClearButton의 표시 여부를 설정하는 속성입니다. 기본값은 false 이며 true로 변경시 ClearButton이 표시됩니다. ClearButton을 클릭하면 파일 인풋에 입려된 파일이 비워집니다.";
							output_79.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_81.value = "Boolean ( Default : false )";
							output_81.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_84.value = "clear버튼의 표시여부를 반환합니다.";
							output_84.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_85.value = "clear버튼의 표시여부를 설정합니다.";
							output_85.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_89.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 파일 인풋 컨트롤에서 해당 속성에 따른 기능을 확인 할 수 있습니다.";
							output_89.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
