/*
 * App URI: app/exam/controls/SearchInput
 * Source Location: app/exam/controls/SearchInput.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/controls/SearchInput", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "인풋박스와 검색버튼이 결합된 컨트롤.\r\n\r\n데이터를 입력할 수 있는 컨트롤입니다.\r\n\r\n데이터 입력, 출력, 수정이 가능합니다.\r\n";
					...
					(function(container){
						...
						(function(container){
							...
							searchInput_1.value = "tomatoSystem";
							searchInput_1.placeholder = "search";
						...
						(function(container){
							...
							userDefinedControl_2.value = "var search1 = new cpr.controls.SearchInput(\"search1\");\r\n\r\nsearch1.value = \"tomatosystem\";\r\nsearch1.placeholder = \"search\";";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "서치인풋 컨트롤에 값이 들어있지 않을때 출력되는 문구를 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 인풋 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var searchInput_2 = new cpr.controls.SearchInput("sampleSpb1");
					...
					(function(container){
						...
						output_20.value = "hideClearButton";
						output_20.style.css({
							"color" : "#2263b3",
							"font-weight" : "700",
							"font-size" : "20px",
						...
						(function(container){
							...
							output_21.value = "서치 인풋의 클리어버튼을 보이지 않게 설정하는 속성입니다. 기본값은 false 이고 true 로 변경 시 ClearButton이 보이지 않게 됩니다.";
						...
						(function(container){
							...
							output_26.value = "clear버튼의 숨김여부를 반환합니다.";
							output_26.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							if(typeof onOutputValueChange == "function") {
								output_26.addEventListener("value-change", onOutputValueChange);
							}
							...
							output_27.value = "clear버튼의 숨김여부를 설정합니다.";
							output_27.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 라디오 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
						...
						(function(container){
							...
							(function(container){
								...
								var searchInput_3 = new cpr.controls.SearchInput("sampleSpb2");
								searchInput_3.value = "tomatosystem";
					...
					(function(container){
						...
						output_33.value = "hideSearchButton";
						output_33.style.css({
							"color" : "#2263b3",
							"font-weight" : "700",
							"font-size" : "20px",
						...
						(function(container){
							...
							output_34.value = "서치 인풋의 검색버튼을 보이지 않게 설정하는 속성입니다. 기본값은 false 이고 true 로 변경 시 SearchButton이 보이지 않게 됩니다.";
						...
						(function(container){
							...
							output_39.value = "search버튼의 숨김여부를 반환합니다.";
							output_39.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_40.value = "search버튼의 숨김여부를 설정합니다.";
							output_40.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_44.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 라디오 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
						...
						(function(container){
							...
							(function(container){
								...
								var searchInput_4 = new cpr.controls.SearchInput("sampleSpb3");
								searchInput_4.value = "tomatosystem";
					...
					(function(container){
						...
						output_46.value = "searchPosition";
						output_46.style.css({
							"color" : "#2263b3",
							"font-weight" : "700",
							"font-size" : "20px",
						...
						(function(container){
							...
							output_47.value = "검색버튼의 위치를 설정하는 속성입니다. 기본값은 right이고 left로 변경 시 검색 버튼이 텍스트 왼쪽으로 이동합니다.";
						...
						(function(container){
							...
							output_52.value = "search버튼의 위치(인풋박스의 왼쪽 또는 오른쪽)를 반환합니다.";
							output_52.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_53.value = "search버튼의 위치(인풋박스의 왼쪽 또는 오른쪽)를 설정합니다.";
							output_53.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_57.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 라디오 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
						...
						(function(container){
							...
							(function(container){
								...
								var searchInput_5 = new cpr.controls.SearchInput("sampleSpb4");
								searchInput_5.value = "tomatosystem";
					...
					(function(container){
						...
						output_59.value = "buttonFocusable";
						output_59.style.css({
							"color" : "#2263b3",
							"font-weight" : "700",
							"font-size" : "20px",
						...
						(function(container){
							...
							output_60.value = "서치 인풋안의 버튼포커스 여부를 설정하는 속성입니다. 기본값은 false 이며 true로 변경시 버튼에 포커스가 갈 수 있습니다.";
						...
						(function(container){
							...
							output_65.value = "버튼에 포커스를 설정값을 반환합니다.";
							output_65.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_66.value = "버튼에 포커스를 설정합니다.";
							output_66.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_71.value = "buttonFocusable = true";
						...
						(function(container){
							...
							(function(container){
								...
								var searchInput_6 = new cpr.controls.SearchInput("sampleSpb5");
								searchInput_6.value = "tomatosystem";
								searchInput_6.buttonFocusable = true;
