		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "HTML스니펫(HTMLSnippet)은 HTML태그를 직접 사용할 수 있는 컨트롤입니다.";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "컨트롤 내부에 있는 텍스트 선택 가능 여부를 설정하는 속성입니다. 기본값은 null이고 true, false로 변경이 가능합니다.";
						...
						(function(container){
							...
							output_18.value = "1) 입력값을 true로 변경하고 실행버튼을 클릭합니다. \r\n2) HTML스니펫 내부의 텍스트가 드래그 되지 않는것을 확인 할 수 있습니다.";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "미리 생성한 html파일을 불러올 수 있는 속성입니다.";
						...
						(function(container){
							...
							output_31.value = "하단의 HTML스니펫에 Pointer Lock API 관련 내용을 확인 할 수 있습니다.";
