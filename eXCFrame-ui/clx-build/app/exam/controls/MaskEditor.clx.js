				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "마스크 에디터에서 데이터 유형을 입력받을 형식을 정하는 속성입니다.";
						...
						(function(container){
							...
							output_18.value = "1) 입력값을 선택하고 실행 버튼을 누르면 하단의 마스크 에디터 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다.\r\n2) 입력값에서 000000-0000000 를 선택하고 실행을 누르면 마스크 에디터에 숫자만 입력되는 것을 확인할 수 있습니다..\r\n3) 입력값에서 000000-0****** 를 선택하고 실행을 누르면 뒷번호중 2번쨰 자리부터 마스킹되어서 표시되는것을 확인할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_23.value = "마스크 에디터에 입력된 알파벳 문자의 처리방식을 설정하는 속성입니다. 기본값은 none 이며 uppercase,lowercase로 변경이 가능합니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_36.value = "입력시 커서 위치기 값을 덮어쓰는 설정입니다. 기본값은 false이며 true로 변경시 커서 위치의 값을 덮어 쓰게 됩니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_49.value = "마스크 에디터에 값이 입력되었을때 값을 비우는 버튼을 표시하는 설정입니다. 기본값은 false이며 true로 변경시 X버튼이 표시됩니다.";
						...
						(function(container){
							...
							output_51.value = "마스크 에디터 내 버튼에 포커스가 갈수 있게 설정하는 속성입니다. 기본값은 false이며 true로 변경시 마스크내부 버튼에 포커스가 갈 수 있습니다.";
						...
						(function(container){
							...
							output_55.value = "1) 마스크에디터에 값을 입력합니다.\r\n2) 우측에 x 표시가 보입니다.\r\n3) Tab 키를 누릅니다.\r\n4) x 표시로 포커스가 갑니다.\r\n5) x 표시를 클릭합니다.\r\n6) 값이 지워집니다.\r\n";
