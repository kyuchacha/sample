				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_3.value = "<기본 링크드 콤보박스 컨트롤>";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "링크드 콤보 박스를 펼쳤을때 최대로 보여지는 아이템의 갯수를 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 링크드 콤보 박스 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "콤보박스의 리스트 넓이를 고정하는 속성입니다. 기본값은 false 이며 , true로 변경시 리스트의 넓이가 고정됩니다.";
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 링크드 콤보 박스 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_31.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_44.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 링크드 콤보 박스 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_44.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "인풋(검색) 기능을 방지하는 속성입니다. 기본값은 false이며 true로 변경 시 인풋(검색)의 기능이 동작하지 않습니다.";
						...
						(function(container){
							...
							output_57.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 링크드 콤보 박스 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_57.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_60.value = "콤보박스 내 아이템을 화면에 보여줄 형식을 표현식의 형태로 정의하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_74.value = "링크드 콤보박스 내의 아이템 활성화 여부를 표현식을 통해 정의하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_88.value = "링크드 콤보박스에서 연결된 하위의 콤보박스들까지 한번에 placeholder를 적용하는 속성입니다.";
						...
						formLayout_22.setColumns(["1fr", "300px", "80px"]);
						...
						(function(container){
							...
							output_99.value = "placeholder = [목록1,목록2,목록3,목록4]";
							output_99.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_102.value = "표현식을 통해 아이템을 필터링 하는 속성입니다.";
