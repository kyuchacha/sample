/*
 * App URI: app/exam/controls/InputBox
 * Source Location: app/exam/controls/InputBox.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/controls/InputBox", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "데이터를 입력할 수 있는 컨트롤입니다.\r\n\r\n데이터 입력, 출력, 수정이 가능합니다.\r\n필터를 사용해서 사용자로부터 제한된 입력을 설정합니다.\r\n인풋박스에 포커스를 가짐과 동시에 입력이 가능합니다.\r\n";
					...
					(function(container){
						...
						(function(container){
							...
							userDefinedControl_2.value = "var inputBox_1 = new cpr.controls.InputBox(\"ipb1\");\r\n\r\ninputBox_1.value = \"tomatoSystem\";";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "인풋 컨트롤에 값이 들어있지 않을때 출력되는 문구를 설정하는 속성입니다.";
						...
						(function(container){
							...
							(function(container){
								...
								var inputBox_2 = new cpr.controls.InputBox("sampleControl");
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "인풋 박스에 password 설정을 할 수 있는 속성입니다. 기본값은 false 이고 true로 변경시 값이 마스킹되어 처리되게 됩니다.";
						...
						(function(container){
							...
							output_26.value = "입력 방식의 password 설정 여부를 반환합니다.";
							output_26.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_27.value = "입력 방식의 password 설정 여부를 설정합니다.";
							output_27.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 인풋 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_31.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var inputBox_3 = new cpr.controls.InputBox("sampleControl2");
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "인풋박스에 최대 입력할 수 있는 길이를 설정하는 속성입니다. lengthUnit에 따라 값이 달라 질 수 있습니다.";
						...
						(function(container){
							...
							output_39.value = "입력이 가능한 최대 문자 수를 반환합니다.";
							output_39.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_44.value = "1) 입력값을 선택하고 실행 버튼을 클릭합니다.\r\n2) 하단의 인풋 박스에 선택값 이상의 텍스트가 입력되지 않는것을 확인 할 수 있습니다. ";
						...
						(function(container){
							...
							(function(container){
								...
								var inputBox_4 = new cpr.controls.InputBox("sampleControl3");
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "인풋박스에 정규표현식을 통해 입력값을 제한 할 수 있는 속성입니다.";
						...
						(function(container){
							...
							output_52.value = "입력 문자에 대한 regexp를 가져옵니다.";
							output_52.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_53.value = "입력 문자에 대한 regexp를 지정합니다.";
							output_53.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_57.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 인풋 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다.\r\n-^[0-9\\-]*$ : 숫자와 하이픈만 입력 할 수 있습니다.\r\n-^[0-9]*$ : 숫자만 입력 할 수 있습니다.\r\n-^[a-zA-Z]*$ : 영어 대문자와 소문자만 입력 할 수 있습니다.";
							...
							(function(comboBox_4){
								comboBox_4.addItem(new cpr.controls.Item("^[0-9\\-]*$", "^[0-9\\-]*$"));
								comboBox_4.addItem(new cpr.controls.Item("^[0-9]*$", "^[0-9]*$"));
								comboBox_4.addItem(new cpr.controls.Item("^[a-zA-Z]*$", "^[a-zA-Z]*$"));
							})(comboBox_4);
						...
						(function(container){
							...
							(function(container){
								...
								var inputBox_5 = new cpr.controls.InputBox("sampleControl4");
