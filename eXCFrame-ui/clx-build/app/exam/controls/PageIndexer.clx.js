		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "대용량 데이터가 보이는 컨트롤에서 총 데이터양과 관계없이 화면에 출력하고자 하는 데이터양만큼만 보이도록 도와주는 컨트롤입니다.\r\n\r\n그리드의 Paging 처리시 사용할 수 있습니다.\r\n\r\n페이지 인덱서가 구성되는 데에는 연결된 그리드의 전체 행의 수(totalRowCount)가 필요합니다. 전체 행의 수를 입력하게 되면 한 페이지에 보여질 행의 수(pageRowCount)로 나누어 총 페이지 수를 계산합니다. 그리고 보여지는 페이지 수(viewPageCount)에 의해 해당 페이지 수 만큼만 한번에 보이게 됩니다.\r\n";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_18.value = "페이지 인덱서의 현재 시작 인덱스 페이지를 선택하는 속성입니다. 기본값은 1 입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_38.value = "1) 입력값을 선택하고 실행 버튼을 클릭합니다.\r\n2) 하단의 페이지 인덱서의 페이지 수가 달라지는 것을 확인 할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_54.value = "각각 페이지의  처음버튼(<<) , 마지막버튼() , 이후버튼(>) , 이전버튼(<) 의 visible 설정을 정하는 속성입니다. 기본값은 true 입니다.";
						...
						(function(container){
							...
							output_64.value = "1) 입력값을 선택하고 실행 버튼을 클릭합니다.\r\n2) 하단의 페이지 인덱서 버튼의에서 해당 속성에 따른 기능을 확인 할 수 있습니다.";
