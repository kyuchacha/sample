				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "임베디드 앱의 활성화 여부를 설정할 수 있는 속성입니다. 기본값은 true 이며, false로 변경 시 임베디드 앱이 활성화 되지 않습니다.";
							output_8.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "임베디드 앱 컨트롤을 수정이 불가능한 읽기 전용 모드로 변경 할 수 있는 속성입니다.  기본값은 false 이며, true 로 변경시 읽기전용 모드로 변경됩니다.";
							output_21.style.css({
								"font-weight" : "700"
							});
