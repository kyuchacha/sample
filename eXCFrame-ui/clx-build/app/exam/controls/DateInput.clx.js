				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "데이트 인풋에서 달력의 타입을 지정하는 속성입니다. 기본값은 yearmonthdate 이고 year,yearmonth로 변경이 가능합니다.\r\n달력의 타입을 변경할 때는 format과 mask의 양식을 통일해주어야 정확한 결과값을 얻을 수 있습니다.";
							output_8.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "데이트 인풋 컨트롤의 달력 버튼을 보이지 않게 하는 속성입니다. 기본값은 false 이고 true 로 변경이 달력버튼이 보이지 않게 됩니다.";
							output_21.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 데이트 인풋 컨트롤에서 달력버튼이 사라지고, 나타나는 것을 확인 할 수 있습니다.";
							output_31.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "입력 받을 날짜의 형식을 정해주는 속성입니다. 인풋박스에서 마스크로 지정됩니다. 년도, 달 , 날짜를 구분 할 수 있는 구분자를 반드시 포함하여야 합니다. 기본값은 YYYY-MM-DD 입니다.\r\n\r\n날짜의 표현식은 다음과 같습니다.\r\n\r\n날짜를 포멧할 표현식\r\n 년도, 달, 날짜:\r\n * `YYYY`: 4자리 연도 -> 2017\r\n * `YY`: 2자리 연도 -> 17\r\n * `MM`: 두자리 월, 한 자리수 인 경우 0으로 채워짐. -> 09\r\n * `M`: 월 -> 9\r\n * `DD`: 두자리 날짜. 한 자리수 인 경우, 0으로 채워짐. 예: 1일 -> 01\r\n * `D`: 날짜\r\n* `h` : 시간 -> 1 5 12\r\n * `hh` : 시간 -> 01 05 12\r\n * `H` : 시간 -> 1 5 12 23\r\n * `HH` : 시간 -> 01 05 12 23\r\n * `m` : 분 -> 1 21 54\r\n * `mm` : 분 -> 01 21 54\r\n * `s` : 초 -> 1 21 54\r\n * `ss` : 초 -> 01 21 54\r\n * `A` : AM PM * `a` : am pm mask는 format의 '주 및 요일'을 적용할 수 없습니다.";
							output_34.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_44.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 데이트 인풋 컨트롤의 표기 형식이 변경되는 것을 확인 할 수 있습니다.";
							output_44.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "데이트 인풋컨트롤을 수정이 불가능한 읽기 전용 모드로 변경 할 수 있는 속성입니다.  기본값은 false 이며, true 로 변경시 읽기전용 모드로 변경됩니다.";
							output_47.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_57.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 데이트 인풋 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_57.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_60.value = "숫자를 변경하는 스핀버튼을 보여줄 수 있는 속성입니다. 기본값은 false 이며 , true로 변경시 스핀버튼이 보이게 됩니다. spinLoop 설정에 따라 값의 순환여부를 결정 할 수 있습니다.\r\n\r\n* spinLoop : false\r\n2019-12-21에서 월을 12에서 증가 시키는 경우 2020-01-21로 갱신됨.\r\n\r\n* spinLoop : true\r\n2019-12-21에서 월을 12에서 증가 시키는 경우 2019-01-21로 갱신됨.";
							output_60.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_70.value = "1) 우측의 입력값을 선택하고 실행 버튼을 클릭합니다.\r\n2) spinLoop의 설정에 따라 값의 순환 여부가 정해집니다.\r\n3) 월 부분을 선택하고 스핀버튼을 눌러서 순환 여부에 따른 차이를 확인 할 수 있습니다.\r\n\r\n* 하단의 기능확인 컨트롤은 spinButton = true 로 설정되어 있습니다.";
							output_70.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_73.value = "달력 아이콘의 위치를 설정하는 속성입니다. 기본값은 right 이고 left로 변경하면 달력아아콘이 인풋의 좌측에 출력됩니다.";
							output_73.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_83.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 데이트 인풋 컨트롤에서 달력아이콘의 위치가 변하는 것을 확인할 수 있습니다.";
							output_83.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_86.value = "데이트 인풋의 달력버튼을 클릭했을때, 달력의 팝업이 출력되는 방향을 설정합니다. 기본값은 auto 이고 top,bottom을 선택해서 달력이 팝업되는 방향을 고정해 줄 수 있습니다.";
							output_86.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_96.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 데이트 인풋 컨트롤에서 달력팝업의 위치가 변하는 것을 확인할 수 있습니다.";
							output_96.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							var group_49 = new cpr.controls.Container("grp12");
							// Layout
					...
					(function(container){
						...
						(function(container){
							...
							output_99.value = "날짜를 클릭했을때, 입력을 방지하는 속성입니다. 기본값은 false 이며 , true 로 변경시 데이트인풋의 입력이 제한됩니다.\r\n[true] : 키보드 입력을 방지하고, 버튼만 동작 가능합니다.\r\n[false] : 키보드 입력이 가능합니다.";
							output_99.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_112.value = "인풋마스크의 동작 여부를 설정하는 속성입니다. 기본값은 true 이며 false로 변경시 인풋마스크가 동작하지 않습니다.";
						...
						(function(container){
							...
							output_122.value = "1) 우측의 입력값을 false로 선택하고 실행버튼을 클릭합니다.\r\n2) 인풋마스크가 동작하지 않고, 한글 이나 영어를 입력 할 수 있습니다.";
					...
					var group_62 = new cpr.controls.Container("grp14");
					...
					(function(container){
						...
						(function(container){
							...
							output_125.value = "ClearButton의 표시 여부를 설정하는 속성입니다. 기본값은 false 이며 true로 변경시 ClearButton이 표시됩니다. ClearButton을 클릭하면 데이트 인풋에 입력된 값이 비워집니다.";
						...
						(function(container){
							...
							output_130.value = "clear버튼의 표시여부를 반환합니다.";
							...
							output_131.value = "clear버튼의 표시여부를 설정합니다.";
