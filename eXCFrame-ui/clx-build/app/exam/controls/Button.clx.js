				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "버튼의 활성화 여부를 결정하는 속성입니다. 기본값은 true 이며 false로 변경시 버튼이 클릭되지 않습니다.";
							output_8.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 버튼 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "버튼의 css visibility 를 제어하는 속성입니다. 기본값은 true 이며 false로 변경 시 버튼이 보이지 않습니다.";
							output_21.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 버튼 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_31.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "버튼위에 커서를 올렸을때 나오는 힌트를 설정하는 속성입니다.";
							output_34.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_44.value = "1) 입력값을 선택하고 실행 버튼을 누르세요.\r\n2) 하단의 버튼컨트롤에 설정된 툴팁을 확인하세요.";
							output_44.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "버튼안의 텍스트를 설정하는 속성입니다.";
							output_47.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_57.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 버튼 컨트롤의 텍스트가 바뀌는것을 확인 할 수 있습니다.";
							output_57.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_60.value = "버튼 안에서 아이콘의 이미지 위치를 설정하는 속성입니다. 기본값은 left 이고 right, bottom, top 으로 변경이 가능합니다.";
							output_60.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_70.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 버튼 컨트롤 아이콘의 위치가 바뀌는것을 확인 할 수 있습니다.";
							output_70.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
