				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "링크드리스트박스의 헤더를 설정하는 속성입니다. 배열형태로 값을 지정 할 수 있습니다.";
						...
						(function(container){
							...
							output_10.value = "링크드 리스트 목록 간의 간격을 설정하는 속성입니다. 기본단위는 px입니다.";
						...
						(function(container){
							...
							output_14.value = "1) 하단의 링크드 리스트박스 헤더가 표시되는 것을 확인 할수 있습니다.\r\n* header= [목록1,목록2,목록3,목록4] \r\n2) 우측의 입력값을 선택하고 확인 버튼을 클릭합니다.\r\n3) 링크드 리스트 박스간의 간격이 변하는것을 확인할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_17.value = "링크드 리스트박스에서 아이템드래그 가능 여부를 결정하는 속성입니다. 기본값은 false이며 true로 변경시 아이템 드래그가 허용됩니다.";
						...
						(function(container){
							...
							output_19.value = "컨트롤에 제공하는 드롭기능의 사용여부를 결정하는 속성입니다. 기본값은 false이며 true로 변경시 컨트롤에 드롭기능을 사용할수 있게 됩니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_27.value = "링크드 리스트 박스 내 아이템을 화면에 보여줄 형식을 표현식의 형태로 정의하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_41.value = "링크드 리스트박스 내의 아이템 활성화 여부를 표현식을 통해 정의하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_55.value = "표현식을 통해 아이템을 필터링 하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_69.value = "링크드 리스트 박스의 목록이 펼쳐질 방향을 선택하는 속성입니다. 기본값은 right 이며 left로 변경이 가능합니다.\r\n[right] : 오른쪽으로 펼쳐집니다.\r\n[left] : 왼쪽으로 펼쳐집니다.";
						...
						(function(container){
							...
							(function(container){
								...
								linkedListBox_7.direction = "left";
