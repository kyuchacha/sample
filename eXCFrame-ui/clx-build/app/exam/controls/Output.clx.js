				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "아웃풋컨트롤의 데이터 표기 형식을 설정하는 속성입니다. datatype 값의 형식에 대한 데이터 유형에 따라 설정합니다.";
						...
						(function(container){
							...
							output_16.value = "format 속성이 date 타입으로 설정되어있을경우 value 형식을 분석하는 포맷값을 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_18.value = "1) 하단의 1번예제 아웃풋컨트롤의 출력값이 주민등록 포맷인것을 확인합니다.\r\n\r\n2) 하단의 2번예제 아웃풋의 출력값이 YYYY-MM-DD 포맷인것을 확인합니다.\r\n\r\n\r\n3) 하단의 3번예제 아웃풋의 출력값이 YYYY-MM-DD 포맷인것을 확인합니다.\r\n\r\n  ";
						...
						(function(container){
							...
							(function(container){
								...
								output_21.value = "1번예제) dataType = String인 경우 format 속성을 지정하여 특정 문자열 데이터에 대한 마스킹 처리를 할 수 있습니다.";
							...
							(function(container){
								...
								output_23.value = "2번예제) 데이터 유형이 날짜인 경우에 dataType=date로 지정하여 날짜 포맷으로 데이터를 표시할 수 있습니다.";
							...
							(function(container){
								...
								output_25.value = "3번예제) 아웃풋의 value가 dateValueFormat의 형식을 분석후 설정한 format형식으로 반환합니다";
					...
					(function(container){
						...
						(function(container){
							...
							(function(container){
								...
								output_40.value = "데이터 유형이 숫자인 경우에 dataType = number로 지정하며, format 속성을 통해 숫자(금액,소수점) 포맷으로 데이터를 표시할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_43.value = "넘버에디터 소수의 구분자를 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_45.value = "정수부의 구분 문자를 설정하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_54.value = "말줄임표 사용 여부를 설정하는 속성입니다. 기본값은 false 이며 true로 설정 시 output의 크기보다 내용이 많을 경우 말줄임표가 사용됩니다.";
