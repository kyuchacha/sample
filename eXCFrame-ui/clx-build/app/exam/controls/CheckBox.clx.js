/*
 * App URI: app/exam/controls/CheckBox
 * Source Location: app/exam/controls/CheckBox.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/controls/CheckBox", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "체크되거나 체크되지 않은 상태를 선택하는 컨트롤입니다.\r\n체크 상태를 토글할 수 있습니다.체크된 상태와 체크되지 않은 상태의 값을 별도로 지정할 수 있습니다.\r\n";
					...
					(function(container){
						...
						(function(container){
							...
							output_3.value = "<기본 체크박스 컨트롤>";
							output_3.style.setClasses(["text-center"]);
							container.addChild(output_3, {
								"colIndex": 0,
								"rowIndex": 1
							});
							var checkBox_1 = new cpr.controls.CheckBox("defaultCbx");
							checkBox_1.text = "checkbox";
						...
						(function(container){
							...
							userDefinedControl_2.value = "var checkbox_1 = new cpr.controls.CheckBox(\"ckb1\");\r\ncheckbox_1.checked = true;\r\ncheckbox_1.text = \"checkbox\";";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "체크 박스 내부에 표시되는 텍스트를 설정하는 속성입니다.";
							output_8.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 체크 박스 내부의 텍스트가 바뀌는 것을 확인 할 수 있습니다.";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var checkBox_2 = new cpr.controls.CheckBox("sampleCbx1");
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "체크박스 안에서 아이콘의 이미지 위치를 설정하는 속성입니다. 기본값은 left 이고 right, bottom, top 으로 변경이 가능합니다.";
							output_21.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_26.value = "get 호출시 반환되는 내용을 입력하세요.";
							output_26.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_27.value = "set으로 설정 가능한 내용을 입력하세요.";
							output_27.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(comboBox_2){
								...
								comboBox_2.addItem(new cpr.controls.Item("top", "top"));
								comboBox_2.addItem(new cpr.controls.Item("bottom", "bottom"));
							})(comboBox_2);
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 체크 박스 컨트롤 아이콘의 위치가 바뀌는것을 확인 할 수 있습니다.";
							output_31.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var checkBox_3 = new cpr.controls.CheckBox("sampleCbx2");
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "체크 박스 컨트롤의 value를 통해 체크 박스의 체크 상태를 컨트롤 할 수 있습니다. ";
							output_34.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_40.value = "컨트롤의 값을 설정하고, value-change 이벤트가 발생됩니다.";
							output_40.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_44.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 체크 박스 컨트롤 체크 상태가 바뀌는것을 확인 할 수 있습니다.";
							output_44.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var checkBox_4 = new cpr.controls.CheckBox("sampleCbx3");
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "컨트롤의 수정 가능 여부를 설정하는 속성입니다. 기본값은 false 이며 true로 변경시 컨트롤을 수정할 수 없게 됩니다.";
							output_47.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_57.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 체크 박스 컨트롤의 읽기 전용모드가 설정되는것을 확인 할 수 있습니다.";
							output_57.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var checkBox_5 = new cpr.controls.CheckBox("sampleCbx4");
								checkBox_5.value = "";
					...
					(function(container){
						...
						(function(container){
							...
							output_60.value = "체크 박스의 활성화 여부를 결정하는 속성입니다. 기본값은 true 이며 false로 변경시 체크박스가 클릭되지 않습니다.";
							output_60.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_62.value = "Boolean ( Default : true )";
							output_62.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_65.value = "컨트롤의 활성화 여부를 반환합니다.";
							output_65.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_66.value = "컨트롤의 활성화 여부를 설정합니다.";
							output_66.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_70.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 체크 박스 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_70.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var checkBox_6 = new cpr.controls.CheckBox("sampleCbx5");
								checkBox_6.value = "";
					...
					(function(container){
						...
						(function(container){
							...
							output_73.value = "체크박스 아이템의 넓이를 고정시키는 속성입니다. 기본값은 false 이며 true로 변경 시 넓이가 고정됩니다.\r\ncheckbox.part.less 에서 말줄임표 스타일을 적용하기 위해서는 fixedWidth = true 로 설정해야 한다.";
							output_73.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_75.value = "Boolean ( Default : true )";
							output_75.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_78.value = "컨트롤의 활성화 여부를 반환합니다.";
							output_78.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_79.value = "컨트롤의 활성화 여부를 설정합니다.";
							output_79.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_83.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 체크 박스 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_83.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var checkBox_7 = new cpr.controls.CheckBox("sampleCbx6");
								checkBox_7.value = "";
								checkBox_7.text = "CheckBox";
