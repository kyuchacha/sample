				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_12.value = "타이틀의 여백부분을 클릭했을때 아코디언의 펼쳐짐 여부를 결정하는 속성입니다. 기본값은 true 이고 false로 변경하면 타이틀 우측의 아이콘을 통해서만 아코디언을 펴고 접을 수 있습니다.";
							output_12.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_22.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 아코디언 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_22.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_29.value = "아코디언 아이템을 한번에 여러개를 펼칠 수 있게 해주는 속성입니다. Default는 false 이며, true 변경하면 여러개를 펼칠 수 있습니다.";
							output_29.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_39.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 아코디언 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_39.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
