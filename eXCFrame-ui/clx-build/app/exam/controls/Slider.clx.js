				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "슬라이더의 값을 설정할 수 있는 속성이다. 슬라이더는 1개 이상의 value값 설정도 가능하다.";
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 슬라이더 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "슬라이더의 진행 방향을 설정할 수 있는 속성이다. 기본값은 forward 이며 , backward로 변경시 역순으로 진행하게 된다.\r\n[forward] : 순방향 \r\n[backward] : 역방향 ";
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 슬라이더 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "슬라이더 값의 범위를 조절 할 수 있도록 슬라이더 값을 2개로 바꿀수 있는 설정이다. 기본값은 false 이며 true로 변경이 가능하다.";
						...
						(function(container){
							...
							output_39.value = "슬라이더의 값을 숫자형으로 얻습니다. range 모드일 때는 IllegalStateException 예외가 던져집니다.";
							output_39.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_40.value = "슬라이더의 값을 number로 지정합니다. range 모드일 때는 IllegalStateException 예외가 던져집니다.";
							output_40.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_44.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 슬라이더 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "슬라이더의 방향을 결정하는 속성이다. 기본값은 horizontal이고 vertical로 변경시 세로로 모양이 바뀌게 된다.\r\n[horizontal] : 가로 방향 \r\n[vertical] : 세로 방향 ";
						...
						(function(container){
							...
							output_57.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 슬라이더 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
					...
					(function(container){
						...
						(function(container){
							...
							output_60.value = "슬라이더의 이동값을 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_70.value = "우측 입력값을 선택하고 실행 버튼을 누르면 하단의 슬라이더 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_73.value = "슬라이더의 최댓값을 설정하는 속성이다.";
						...
						(function(container){
							...
							output_75.value = "슬라이더의 최솟값을 설정하는 속성이다.";
						...
						formLayout_18.setColumns(["1fr", "200px", "80px"]);
						formLayout_18.setRows(["30px", "30px"]);
						formLayout_18.setCustomRowShade(0, "#edeff6");
						...
						(function(container){
							...
							output_79.value = "1) 하단의 컨트롤에서 우측의 입력값이 적용된 컨트롤을 확인할 수 있습니다.\r\n2) 슬라이더의 최솟값이 20, 최대값이 80인것을 확인할 수 있습니다.\r\n* 슬라이더는 양옆으로 끝까지 이동가능 합니다.";
							...
							output_80.value = "min = 20.0\r\nmax = 80.0";
							output_80.style.setClasses(["opt-tmpl"]);
							output_80.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
