		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "숫자를 입력하는 컨트롤입니다.\r\n\r\n음수, 양수 데이터 유형별 포맷이 됩니다.\r\n소수점 입력이 가능하며 소수부분 범위 지정이 됩니다.\r\n넘버에디터에 포커스를 가짐과 동시에 입력이 됩니다. \r\n";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_20.value = "1) 입력값을 선택하고 실행 버튼을 누릅니다.\r\n2) 하단의 넘버에디터에서 선택값에 형식을 확인합니다.\r\n* 입력값에 마우스를 해당 값의 의미를 확인 할 수 있습니다. ";
					...
					(function(container){
						...
						(function(container){
							...
							output_33.value = "1) 하단의 컨트롤에 1900을 입력합니다.\r\n2) 우측 아래 화살표를 클릭합니다.\r\n3) 숫자가 내려가지 않는것을 확인할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_37.value = "넘버 에디터의 스핀버튼을 설정하는 속성입니다. 기본값은 true이고 false로 변경시 스핀버튼이 보이지 않습니다.";
						...
						(function(container){
							...
							output_39.value = "스핀버튼으로 증감되는 값을 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_43.value = "1) 우측의 입력값을 선택합니다.\r\n2) 실행 버튼을 클릭후 하단의 컨트롤에서 해당 속성에 관련된 기능을 확인 할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_46.value = "컨트롤을 수정이 불가능한 읽기 전용 모드로 변경 할 수 있는 속성입니다.  기본값은 false 이며, true 로 변경시 읽기전용 모드로 변경됩니다.";
						...
						(function(container){
							...
							output_56.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 넘버에디터 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_56.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_59.value = "넘버에디터를 클릭했을때, 입력을 방지하는 속성입니다. 기본값은 false 이며 true 로 변경시 인풋 입력이 제한됩니다.\r\n[true] : 키보드 입력을 방지하고, 버튼만 동작 가능합니다.\r\n[false] : 키보드 입력이 가능합니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_72.value = "넘버에디터를 클릭했을때 포커스 영역의 데이터 전체 선택여부를 설정하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_85.value = "ClearButton의 표시 여부를 설정하는 속성입니다. 기본값은 false 이며 true로 변경시 ClearButton이 표시됩니다. ClearButton을 클릭하면 입력된 값이 비워집니다.";
						...
						(function(container){
							...
							output_87.value = "컨트롤내 버튼 포커스 여부를 설정하는 속성입니다. 기본값은 false 이며 true로 변경시 버튼에 포커스가 가게 됩니다.";
						...
						(function(container){
							...
							output_91.value = "1) 넘버 에디터에 숫자를 클릭합니다.\r\n2) Tab키를 누릅니다.\r\n3) x 표시로 포커스가 이동합니다.\r\n4) x 표시를 누르면 숫자가 지워지는것을 확인할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_95.value = "넘버데이터의 인풋 마스킹 여부를 설정하는 속성입니다. 기본값은 true이며 false로 변경시 마스크가 동작하지 않습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_108.value = "포커스 상태가 아닐 때 넘버에디터값을 보여줄 형식을 표현식의 형태로 정의하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_122.value = "넘버에디터 컨트롤에 값이 들어있지 않을때 출력되는 문구를 설정하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_135.value = "넘버에디터 소수의 구분자를 설정하는 속성입니다.";
