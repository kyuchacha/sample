				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "브라우저 기본 컨트롤을 보여줄지 여부를 결정하는 속성입니다. 기본값은 false로 변경시 브라우저 기본 컨트롤이 보여집니다. ";
							output_8.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_12.value = "반복 여부를 결정하는 속성입니다. 기본값은 false로 변경시 비디오가 반복되서 재생됩니다. ";
							output_12.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_20.value = "음소거 여부를 결정하는 속성입니다. 기본값은 false로 변경시 소리가 나옵니다. ";
							output_20.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_28.value = "페이지가 로드 될 때 비디오를 로드할지 여부를 결정하는 속성입니다. 기본값은 auto로 비디오를 미리 로드합니다.";
							output_28.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_49.value = "자동 시작의 여부를 결정하는 속성입니다. 기본값은 false로 변경시 비디오를 자동 재생합니다.";
							output_49.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_53.value = "1. 재생을 누르지않아도 페이지 로드 시 자동으로 재생됩니다.";
							output_53.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
