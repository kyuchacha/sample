				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							userDefinedControl_2.value = "var tree_1 = new cpr.controls.Tree(\"tre1\");";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "아이템의 다중 선택 여부를 결정하는 속성입니다. 기본값은 false로 변경시 여러 아이템을 선택할 수 있습니다.";
							output_8.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_12.value = "왼쪽 트리는 여러 아이템 선택이 안되는 반면, 오른쪽 트리는 여러 아이템이 선택됩니다.";
							output_12.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								(function(container){
									...
									tree_3.showSelectionCheckbox = false;
					...
					(function(container){
						...
						(function(container){
							...
							output_16.value = "트리 아이템이 선택되었을때 체크되는 체크박스 표시 속성입니다. 기본값은 auto입니다.";
							output_16.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_26.value = "Item 선택 유형을 결정하는 속성입니다. 기본값은 allchild로 부모 선택 시 자식까지 선택되고, single로 변경시 부모만 선택됩니다.";
							output_26.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_30.value = "트리의 선을 보여줄지 여부를 결정하는 속성입니다. 기본값은 false고, 변경시 트리의 아이템들이 선으로 연결되어 보입니다.";
							output_30.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "자동으로 아이템을 열어 주는 깊이의 값을 결정하는 속성입니다. 기본값은 0이고, -1을 입력 시 모두 펼쳐져서 보입니다.";
							output_34.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						output_37.value = "draggableItem / allDrop";
						output_37.style.css({
							"color" : "#2263b3",
							"font-weight" : "700",
							"font-size" : "20px",
						...
						(function(container){
							...
							output_38.value = "draggableItem은 아이템을 drag 가능한 지에 대한 여부를 결정하는 속성입니다. 기본값은 false고 변경시 드래그가 가능합니다.\r\nallDrop은 아이템을 drop 가능한 지에 대한 여부를 결정하는 속성입니다. 기본값은 false고 변경시 드랍이 가능합니다.";
							output_38.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_42.value = "아이템을 드래그앤드랍 시 해당 위치로 옮겨집니다.";
							output_42.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
