				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "오디오 컨트롤을 보여주는 속성입니다. 기본값은 false 이며 , true 로 변경시 브라우저에서 제공하는 오디오 컨트롤의 재생,소리,자막 등 UI 조작을 할수 있는 컨트롤을 표시합니다.";
							output_8.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 오디오 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "오디오를 반복재생하는 속성입니다. 기본값은 false 이며, true로 변경 시 오디오가 반복재생됩니다.";
							output_21.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 오디오 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_31.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "오디오 컨트롤을 음소거 하는 속성입니다. 기본값은 false 이며, true로 변경시 오디오가 음소거 됩니다.";
							output_34.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_44.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 오디오 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_44.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "오디오가 자동으로 시작되는 속성입니다. 기본값은 false이며, true로 변경시 오디오가 자동 재생됩니다. \r\n하지만 이 옵션은 브라우저에 정책에 따라 동작되기 때문에 브라우저 또는 맥에서 autoplay에 관련 설정을 해주어야 음소거 없이 동작할 수 있습니다. \r\n브라우저에서 동작이 안되는 경우 각 브라우저의 autoplay 설정을 참고하시기 바랍니다.";
							output_47.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_57.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 오디오 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_57.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_60.value = "페이지가 로드될때 , 오디오를 로드할지 여부를 선택하는 속성입니다. 기본값은 'auto' 이고, 3가지 설정값이 존재합니다.\r\n\r\n- auto : 사용자가 우선순위를 가지고있지만 필요하다면 전체 비디오가 로드 될 수 있습니다.\r\n- metadata : 메타데이터를 미리 가져와 로드합니다. \r\n- none : 최소한의 트래픽을 유지해 비디오가 캐시되지 않고 로드합니다";
							output_60.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_70.value = "아래에서 preload = none 이 설정된 오디오 컨트롤을 확인할 수 있습니다.";
							output_70.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
