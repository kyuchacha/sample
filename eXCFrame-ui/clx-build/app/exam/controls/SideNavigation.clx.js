				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "사이드내비게이션의 아이템을 선택할수 있는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_22.value = "아이템의 화면에 보여지는 텍스트를 표현식의 형태로 정의하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_64.value = "표현식을 통해 아이템을 필터링 하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_77.value = "자식 트리 노드의 들여쓰기 간격을 지정하는 속성입니다. 기본값은 20입니다.";
						...
						(function(container){
							...
							output_82.value = "자식 트리 노드의 들여쓰기 간격을 얻습니다. ";
							output_82.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_83.value = "자식 트리 노드의 들여쓰기 간격을 지정합니다. -1인 경우 간격 설정을 해제합니다.";
							output_83.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_87.value = "1) 입력값을 선택하고 확인 버튼을 클릭합니다.\r\n2) File 아이템을 클릭한다.\r\n3) 들여쓰기 간격이 선택한 간격만큼 바뀐것을 확인 할 수 있습니다.";
