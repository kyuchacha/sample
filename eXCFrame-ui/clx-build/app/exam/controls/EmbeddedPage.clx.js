/*
 * App URI: app/exam/controls/EmbeddedPage
 * Source Location: app/exam/controls/EmbeddedPage.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/controls/EmbeddedPage", {
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_3.value = "<기본 임베디드 페이지 컨트롤>";
							output_3.style.setClasses(["text-center"]);
							container.addChild(output_3, {
								"colIndex": 0,
								"rowIndex": 1
							});
							var embeddedPage_1 = new cpr.controls.EmbeddedPage("defaultEmp");
							embeddedPage_1.src = "app/exam/controls/embedded/embeddedPage_sample01.html";
						...
						(function(container){
							...
							userDefinedControl_2.value = "// UI Configuration\r\nvar embeddedPage = new cpr.controls.Embeddedpage(\"embpage1\");\r\nembeddedPage.src=\"./sample.html\";";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "iframe의 name 속성을 설정하는 속성입니다. ";
							output_8.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_13.value = "iframe의 name 속성을 반환합니다.";
							output_13.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_14.value = "iframe의 name 속성을 설정합니다.";
							output_14.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								output_20.value = "<기능확인 컨트롤>";
								output_20.style.setClasses(["text-center"]);
								container.addChild(output_20, {
									"colIndex": 0,
									"rowIndex": 1
								});
								var embeddedPage_2 = new cpr.controls.EmbeddedPage("sampleEmp1");
								embeddedPage_2.src = "app/exam/controls/embedded/embeddedPage_sample01.html";
								embeddedPage_2.frameName = "EmbeddedPage";
					...
					(function(container){
						...
						(function(container){
							...
							output_22.value = "임베디드 페이지 내에서 스크롤을 생성하는 속성입니다. 기본값은 auto이고 yes,no를 수동으로 지정 할 수 있습니다.\r\n[yes] : 스크롤을 항상 설정합니다.\r\n[no] : 스크롤을 설정하지 않습니다.\r\n[auto] : 스크롤이 필요할 시 설정됩니다.";
							output_22.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_27.value = "page의 스크롤 상태를 반환합니다.";
							output_27.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_28.value = "page의 스크롤 상태를 설정합니다. ";
							output_28.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_32.value = "1) 하단의 임베디드 페이지에서 스크롤을 내려봅니다.\r\n2) 스크롤이 생기지 않습니다.";
							output_32.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var embeddedPage_3 = new cpr.controls.EmbeddedPage("sampleEmp2");
								embeddedPage_3.src = "app/exam/controls/embedded/embeddedPage_sample01.html";
								embeddedPage_3.frameName = "EmbeddedPage";
								embeddedPage_3.scrolling = "no";
								container.addChild(embeddedPage_3, {
									"colIndex": 0,
									"rowIndex": 0
								});
							})(group_19);
