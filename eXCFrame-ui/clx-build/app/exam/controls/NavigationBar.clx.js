				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "내비게이션바의 메뉴 타입을 설정하는 속성이니다. 기본값은 menu 이고 megamenu,fullmenu로 변경이 가능합니다.";
						...
						(function(container){
							...
							output_14.value = "메뉴의 타입을 설정합니다. \"menu\",\"megamenu\",\"fullmenu\" 기본 값은 \"menu\"입니다.";
							output_14.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(comboBox_1){
								comboBox_1.addItem(new cpr.controls.Item("megamenu", "megamenu"));
								comboBox_1.addItem(new cpr.controls.Item("fullmenu", "fullmenu"));
							})(comboBox_1);
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면 해당하는 타입의 내비게이션 컨트롤을 확인 할 수있습니다. ";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_22.value = "서브메뉴를 확장하는 방법을 설정하는 속성입니다. 기본값은 hover이며 click으로 변경 시 클릭하기 이전에는 메뉴가 확장되지 않습니다.";
						...
						(function(container){
							...
							output_32.value = "1) 우측의 입력값을 선택하고 확인 버튼을 클릭합니다.\r\n2) 하단의 컨트롤에서 서브메뉴가 펼쳐지는 방법이 변경되는 것을 확인할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_48.value = "내비게이션바 내 아이템을 화면에 보여줄 형식을 표현식의 형태로 정의하는 속성입니다.";
					...
					(function(container){
						...
						group_34.setLayout(verticalLayout_15);
						(function(container){
							var output_62 = new cpr.controls.Output();
							output_62.value = "내비게이션 바 내부 아이템 활성화 여부를 표현식을 통해 정의하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_76.value = "표현식을 통해 아이템을 필터링 하는 속성입니다.";
