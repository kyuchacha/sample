			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						output_4.value = "알림컨트롤의 메시지는 알림컨트롤이 보여지는 위치를 기준으로 나타나기 때문에 알림컨트롤은 항상보이는 위치에 있어야 합니다.\r\n보이지 않는 탭아이템 내부 또는 visible=false 인 컨테이너 내부 등과 같은 곳에 알림컨트롤이 포함될 경우 메시지는 출력되지 않습니다. ";
						output_4.style.css({
							"color" : "#FF9149"
						});
					...
					(function(container){
						...
						(function(container){
							...
							output_5.value = "위 버튼을 클릭하여 기본 알림설정을 확인하세요";
				...
				(function(container){
					...
					output_7.value = "자주 사용되는 속성과 , 시나리오를 통한 예제를 확인할 수 있습니다. 자세한 사항은  Help Contents를 참조하시기 바랍니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_9.value = "최대로 표시할 수 있는 알림의 숫자를 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_11.value = "알림창이 표시되는 시간을 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_13.value = "알림이 표시될 범위를 결정하는 속성입니다. 기본값은 system이고 app으로 변경시 앱영역내에만 알림이 출력되게 됩니다.";
							output_13.style.setClasses(["opt-tmpl"]);
							output_13.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_15.value = "알림창에 아이콘을 설정하는 기능입니다.";
						...
						formLayout_2.setColumns(["1fr", "300px", "80px"]);
						...
						(function(container){
							...
							output_20.value = "maxNotifyCount = 3\r\ndelay = 10000(10초)\r\nscope = system";
