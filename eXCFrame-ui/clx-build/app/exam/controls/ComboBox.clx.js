		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "미리 정해진 값들 중에서 단일 값을 선택하는 컨트롤입니다. 드롭 다운 방식의 목록을 사용합니다.\r\n사용자가 목록에서 골라서 입력하는 것과, 타자로 많은 후보값 중에서 1개를 선택하는것을 모두 지원합니다.\r\n검색 기능을 이용하면 1~2글자를 입력하는것으로 후보값중에서 빠르게 적은 숫자의 후보값으로 추려내어 입력하는 것이 가능합니다.\r\n";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "인풋(검색) 기능을 방지하는 속성입니다. 기본값은 false이며 true로 변경 시 인풋(검색)의 기능이 동작하지 않습니다.\r\n";
							output_8.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 콤보 박스 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "콤보박스의 ▽ 버튼을 숨겨주는 속성입니다. 기본값은 false 이며 , true 로 변경시 해당 버튼이 사라지고 목록이 드롭다운 되지 않습니다.";
							output_21.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 콤보 박스 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_31.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "콤보 박스의 아이템이 최대로 표시되는 개수를 설정하는 속성입니다. 기본값은 '0'으로 리스트박스에 설정된 높이로 표시됩니다.";
							output_34.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_44.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 콤보 박스 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_44.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "콤보 박스의 아이템을 다중 선택 할 수 있게 해주는 속성입니다. 기본값은 false 이며 true 로 변경시 다중 선택이 가능해지고, 아이템 앞에 체크 박스 이미지가 보여집니다.";
							output_47.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_57.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 콤보 박스 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_57.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_60.value = "콤보 박스 리스트 아이템의 아이콘 표시 여부를 결정하는 속성입니다. 기본값은 false 이며 true로 변경 시 리스트의 아이템에 아이콘이 표시됩니다.";
							output_60.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_70.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 콤보 박스 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_70.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_79.value = "아이템의 enabled를 item에 바인드된 데이터셋의 컬럼이나 label,value의 값으로 설정할 수 있습니다. ex) label != 'label1'";
							output_79.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_83.value = "1) 우측의 실행 버튼을 클릭합니다.\r\n2) 하단의 콤보 박스 컨트롤에 enabledItemExp = (value == '02' || value == '03') ? false : true 가 설정됩니다.\r\n3) value2,value3 아이템이 비활성화 되는것을 확인 할 수 있습니다.";
							output_83.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_86.value = "콤보 박스의 목록을 표시하는 방법을 정하는 설정입니다. 기본값은 list 이며 , tree로 변경이 가능합니다.";
							output_86.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_96.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 콤보 박스 컨트롤의 목록 표시 방법이 바뀌는것을 확인 할 수 있습니다.";
							output_96.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
