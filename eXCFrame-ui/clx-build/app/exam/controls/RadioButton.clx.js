/*
 * App URI: app/exam/controls/RadioButton
 * Source Location: app/exam/controls/RadioButton.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/controls/RadioButton", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "여러 가지 선택 사항 중 한 가지 만 선택하는 컨트롤입니다.\r\n\r\n하나의 선택사항에 대하여 여러 개의 라디오 버튼들이 그룹을 이루어 사용된다는 특징이 있습니다. 같은 그룹에 속한 라디오 버튼 중 하나만 선택할 수 있습니다. 사용자에 의해 라디오 버튼이 선택되면 같은 그룹에 속한 다른 모든 라디오 버튼은 선택 해제됩니다. \r\n\r\n라디오버튼에 보여지는 아이템은 두 종류로 구성할 수 있습니다.\r\n";
					...
					(function(container){
						...
						(function(container){
							...
							output_3.value = "<기본 라디오 버튼 컨트롤>";
							output_3.style.setClasses(["text-center"]);
							container.addChild(output_3, {
								"colIndex": 0,
								"rowIndex": 1
							});
							var radioButton_1 = new cpr.controls.RadioButton("defaultRdb");
						...
						(function(container){
							...
							userDefinedControl_2.value = "var radioButton_1 = new cpr.controls.RadioButton(\"rdb1\");\r\nradioButton_1.addItem(new cpr.controls.Item(\"item1\", \"value1\"));\r\nradioButton_1.addItem(new cpr.controls.Item(\"item2\", \"value2\"));\r\nradioButton_1.addItem(new cpr.controls.Item(\"item3\", \"value3\"));\r\n\t\r\nradioButton_1.value = \"value3\";123456";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "라디오 박스내 아이템의 길이에 따른 넓이고정 여부를 정하는 속성입니다. 기본값은 true이고 false로 변경시 아이템 길이에 맞게 넓이가 조절됩니다.";
						...
						(function(container){
							...
							output_13.value = "get 호출시 반환되는 내용을 입력하세요.";
							output_13.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_14.value = "set으로 설정 가능한 내용을 입력하세요.";
							output_14.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 라디오 컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
						...
						(function(container){
							...
							(function(container){
								...
								var radioButton_2 = new cpr.controls.RadioButton("sampleRdb1");
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "라디오버튼에서 한줄에 표시되는 아이템의 숫자를 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_26.value = "한 줄에 보여질 아이템 수를 반환합니다.";
							output_26.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_27.value = "한 줄에 보여질 아이템 수를 설정합니다.";
							output_27.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 라디오 버튼컨트롤에서 해당 속성의 기능을 확인 할 수있습니다. ";
							output_31.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var radioButton_3 = new cpr.controls.RadioButton("sampleRdb2");
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "라디오버튼의 토글 아이콘의 위치를 정하는 속성입니다. 기본갑은 left이고 right,top,bottom 으로 변경이 가능하다.";
						...
						(function(container){
							...
							output_39.value = "아이콘 정렬 위치를 반환합니다.";
							output_39.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_40.value = "아이콘 정렬 위치를 설정합니다.";
							output_40.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_44.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 라디오 버튼 컨트롤 아이콘의 위치가 바뀌는것을 확인 할 수 있습니다.";
							output_44.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var radioButton_4 = new cpr.controls.RadioButton("sampleRdb3");
								radioButton_4.fixedWidth = true;
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "아이템의 화면에 보여지는 텍스트를 표현식의 형태로 정의하는 속성입니다.";
						...
						(function(container){
							...
							output_52.value = "화면에 보여지는 텍스트의 Expression을 반환합니다.";
							output_52.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_57.value = "1) 하단의 컨트롤에서 우측의 입력값이 적용된 컨트롤을 확인할 수 있습니다.\r\n2) 아이템들이 서울[10]의 포맷으로 표시되는것을 확인 할 수 있습니다.";
							...
							output_58.value = "displayExp = CD_NM + \"[\"+CD+\"]\"";
						...
						(function(container){
							...
							(function(container){
								...
								output_59.value = "<기능 확인 컨트롤>";
								output_59.style.setClasses(["text-center"]);
								container.addChild(output_59, {
									"colIndex": 0,
									"rowIndex": 1
								});
								var radioButton_5 = new cpr.controls.RadioButton("sampleRdb4");
					...
					(function(container){
						...
						output_60.value = "enabledItemExp";
						output_60.style.css({
							"color" : "#2263b3",
							"font-weight" : "700",
							"font-size" : "20px",
						...
						(function(container){
							...
							output_61.value = "아이템 활성화 여부를 표현식을 통해 정의하는 속성입니다.";
						...
						(function(container){
							...
							output_66.value = "아이템의 enabled 익스프레션 값을 반환합니다.";
							output_66.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_67.value = "아이템의 enabled를 item에 바인드된 데이터셋의 컬럼이나 label,value의 값으로 설정할 수 있습니다. ex) label != 'label1'";
							output_67.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						formLayout_16.setColumns(["1fr", "500px", "80px"]);
						...
						(function(container){
							...
							output_71.value = "enabledItemExp : (value == '20' || value == '30') ? false : true";
						...
						(function(container){
							...
							(function(container){
								...
								output_73.value = "<기능 확인 컨트롤>";
								output_73.style.setClasses(["text-center"]);
								container.addChild(output_73, {
									"colIndex": 0,
									"rowIndex": 1
								});
								var radioButton_6 = new cpr.controls.RadioButton("sampleRdb5");
					...
					(function(container){
						...
						(function(container){
							...
							output_75.value = "표현식을 통해 아이템을 필터링 하는 속성입니다.";
						...
						(function(container){
							...
							output_80.value = "아이템을 필터하는 익스프레션의 값을 반환합니다.";
							output_80.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_81.value = "아이템을 필터하는 익스프레션을 설정합니다.";
							output_81.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						formLayout_19.setColumns(["1fr", "400px", "80px"]);
						...
						(function(container){
							...
							var button_6 = new cpr.controls.Button("btnInit7");
							button_6.value = "실행";
							...
							output_85.value = "1) 하단의 컨트롤에서 우측의 입력값이 적용된 컨트롤을 확인할 수 있습니다.\r\n2) 서울을 제외한 다른 값들이 보이지 않는것을 확인 할 수 있습니다.";
							...
							output_86.value = "filterExp : CD_NM == \"서울\"";
							output_86.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
