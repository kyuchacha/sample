				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "리스트박스에서 아이템드래그 가능 여부를 결정하는 속성입니다. 기본값은 false이며 true로 변경시 아이템 드래그가 허용됩니다.";
						...
						(function(container){
							...
							output_10.value = "컨트롤에 제공하는 드롭기능의 사용여부를 결정하는 속성입니다. 기본값은 false이며 true로 변경시 컨트롤에 드롭기능을 사용할수 있게 됩니다.";
						...
						(function(container){
							...
							output_12.value = "리스트박스 아이템의 다중선택 가능여부를 결정하는 속성입니다. 기본값은 false이며 true로 변경시 다중선택이 가능하게 됩니다.";
						...
						(function(container){
							...
							output_16.value = "1) 하단의 리스트 박스에서 아이템을 다른위치로 드래그앤드랍합니다.\r\n2) 아이템의 위치가 변경되는것을 확인 할 수 있습니다.\r\n3) 아이템을 클릭합니다.\r\n4) Shift를 누른채로 다른 아이템을 클릭합니다.\r\n5) 여러 아이템이 동시에 선택 되는것을 확인할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_48.value = "표현식을 통해 아이템을 필터링 하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_62.value = "리스트박스 아이템들에 아이콘을 표시여부를 결정하는 속성입니다. 기본값은 false 이며 true로 변경시 아이템의 좌측에 아이콘이 표시되게 됩니다.";
