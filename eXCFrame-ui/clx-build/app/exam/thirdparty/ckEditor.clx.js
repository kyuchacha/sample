/*
 * App URI: app/exam/thirdparty/ckEditor
 * Source Location: app/exam/thirdparty/ckEditor.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/thirdparty/ckEditor", {
		onPrepare: function(loader){
			loader.addCSS("thirdparty/ckeditor4/contents.css");
			loader.addScript("thirdparty/ckeditor4/ckeditor.js");
		},
			...
			* ckEditor2.js
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "CKEditor4 라이브러리를 사용한 텍스트 에디터를 구현한 화면입니다.";
				...
				(function(container){
					...
					output_4.value = "1. 기능확인 상단 에디터에 값을 입력합니다.\r\n2. 에디터 우측 하단에 '에디터 값 가져오기' 버튼을 클릭합니다.\r\n3. 결과창에 HTML 코드로 정상적으로 변환되어 값이 출력되는지 확인합니다.";
					...
					(function(container){
						...
						button_1.value = "https://ckeditor.com/ckeditor-4/download/";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							var uIControlShell_1 = linker.uIControlShell_1 = new cpr.controls.UIControlShell("shlCkEditor");
							...
							formLayout_2.setColumns(["1fr", "130px"]);
				...
				(function(container){
					...
					(function(container){
						...
						output_11.value = "CKEditor4 v4.17.2";
						output_11.style.css({
							"color" : "#FF9149"
						});
					...
					(function(container){
						...
						output_13.value = " - GNU 일반 공공 라이선스 버전 2 이상(\"GPL\")\r\n - GNU Lesser 일반 공공 라이선스 버전 2.1 이상(\"LGPL\")\r\n - Mozilla 공공 라이선스 버전 1.1 이상(\"MPL\")";
						output_13.style.css({
							"color" : "#FF9149"
						});
