...
MsgKit.prototype.alertDialog = function(app, psMsgId, paArgs) {
	this._appKit.Dialog.open(app, "app/cmn/alert", 350, 250, null, this.getMsg(psMsgId, paArgs))
};
...
MsgKit.prototype.confirmDialog = function(app, psMsgId, paArgs, pfCloseCallback) {
	return this._appKit.Dialog.open(app, "app/cmn/confirm", 350, 250, pfCloseCallback, this.getMsg(psMsgId, paArgs))
};
