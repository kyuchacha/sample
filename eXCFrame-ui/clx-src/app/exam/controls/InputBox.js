/************************************************
 * InputBox.js
 * Created at 2022. 3. 8. 오후 2:23:19.
 *
 * @author 1amthomas
 ************************************************/
...
function onBtnInitClick(e){
	...
	app.lookup("sampleControl").placeholder = select;
}
...
function onBtnInit2Click(e){
	...
	if(select == "true"){
		app.lookup("sampleControl2").secret = true;		
	}else{
		app.lookup("sampleControl2").secret = false;	
	}
	app.lookup("sampleControl2").focus();	
...
function onBtnInit3Click(e){
	...
	app.lookup("sampleControl3").maxLength = Number(select);	
}
...
function onBtnInit4Click(e){
	...
	app.lookup("sampleControl4").inputFilter = select;
	console.log(app.lookup("sampleControl4").inputFilter);
}
