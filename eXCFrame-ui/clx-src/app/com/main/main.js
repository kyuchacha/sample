...
function doOpenMenu(appId, poRow){
...
//	});
	...
	if ("Y" == vsDivideMdiUseYn) {
		...
		if (mdiCn.getTabItems().length > 1) {
			mdiCn.getSelectedTabItem().userAttr({
				"__menuInfo": JSON.stringify(poRow.getRowData())
			});
		}
...
function changeToMobile() {
	...
	util.Control.setVisible(app, false, ["cbxToggle", "nvbMgMenu", "btnSearch","grpBtnSearch"]);
...
//		}
	...
	util.Control.setVisible(app, true, ["cbxToggle", "nvbMgMenu",  "btnSearch","grpBtnSearch"]);
...
function onBtnSearchClick(/* cpr.events.CMouseEvent */ e){
	...
	//util.Control.setValue(app, "cbxToggle", "true");
}
